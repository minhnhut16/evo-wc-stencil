...
var ITF = function (_Barcode) {
	...
	_createClass(ITF, [{
		...
		value: function encode() {
			...
			return {
				data: constants.START_BIN + encoded + constants.END_BIN,
				text: this.text
			};
		}
		...
		value: function encodePair(pair) {
			var second = constants.BINARIES[pair[1]];

			return constants.BINARIES[pair[0]].split('').map(function (first, idx) {
...
const JsBarcode = /*@__PURE__*/getDefaultExportFromCjs(JsBarcode_1);
...
const indexCss$2 = ".bar-code{display:flex;justify-content:center}";
...
const BarCode = class {
  ...
  render() {
    return (index.h(index.Host, { id: this.barcodeId }, index.h("div", { class: "bar-code" }, index.h("svg", null))));
  }
};
BarCode.style = indexCss$2;

const indexCss$1 = ".layout-app-wrapper{display:-ms-flexbox;display:flex;-ms-flex:auto;flex:auto;-ms-flex-direction:column;flex-direction:column;min-height:0}.layout-app-wrapper .inner{max-width:411px;margin:0 auto;width:100%;background:#ffffff}.layout-app-wrapper .loading{width:100px;margin:0 auto;display:block}@media (min-width: 461px){.layout-app-wrapper{padding:50px 0;background:transparent}}";
...
const VoucherContent = class {
  ...
  // eslint-disable-next-line class-methods-use-this
  render() {
    return (index.h("div", { class: "voucher-content" }, index.h("div", { class: "title" }, state.voucher.title), index.h("div", { class: "content" }, state.voucher.subTitle), index.h("img", { class: "banner", src: state.voucher.banner }), index.h("div", { class: "title" }, "\u0110i\u1EC1u ki\u1EC7n \u00E1p d\u1EE5ng"), state.voucher.condition && index.h("div", { class: "content", innerHTML: lib.parse(state.voucher.condition) })));
  }
};
VoucherContent.style = indexCss;

exports.bar_code = BarCode;
exports.layout_app = Layout;
exports.voucher_content = VoucherContent;
